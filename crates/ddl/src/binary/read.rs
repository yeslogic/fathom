...
pub fn read_ty(
    ...
    match term {
        core::Term::U8(_) => Ok(Term::U8(ctxt.read::<ddl_rt::U8>()?)),
        core::Term::U16Le(_) => Ok(Term::U16(ctxt.read::<ddl_rt::U16Le>()?)),
        core::Term::U16Be(_) => Ok(Term::U16(ctxt.read::<ddl_rt::U16Be>()?)),
        core::Term::U32Le(_) => Ok(Term::U32(ctxt.read::<ddl_rt::U32Le>()?)),
        core::Term::U32Be(_) => Ok(Term::U32(ctxt.read::<ddl_rt::U32Be>()?)),
        core::Term::U64Le(_) => Ok(Term::U64(ctxt.read::<ddl_rt::U64Le>()?)),
        core::Term::U64Be(_) => Ok(Term::U64(ctxt.read::<ddl_rt::U64Be>()?)),
        core::Term::S8(_) => Ok(Term::S8(ctxt.read::<ddl_rt::I8>()?)),
        core::Term::S16Le(_) => Ok(Term::S16(ctxt.read::<ddl_rt::I16Le>()?)),
        core::Term::S16Be(_) => Ok(Term::S16(ctxt.read::<ddl_rt::I16Be>()?)),
        core::Term::S32Le(_) => Ok(Term::S32(ctxt.read::<ddl_rt::I32Le>()?)),
        core::Term::S32Be(_) => Ok(Term::S32(ctxt.read::<ddl_rt::I32Be>()?)),
        core::Term::S64Le(_) => Ok(Term::S64(ctxt.read::<ddl_rt::I64Le>()?)),
        core::Term::S64Be(_) => Ok(Term::S64(ctxt.read::<ddl_rt::I64Be>()?)),
