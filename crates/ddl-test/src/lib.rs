...
mod alias {
    ...
    test!(pass_format_array, "alias/pass_format_array.ddl");
    ...
    test!(fail_format_array_bad_elem, "alias/fail_format_array_bad_elem.ddl");
    test!(fail_format_array_bad_len, "alias/fail_format_array_bad_len.ddl");
